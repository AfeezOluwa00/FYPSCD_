...
public class MyHydrationVisualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_visual_hydration);
        ...
        fireStoreDB.getAllGraphHydrationData(MyHydrationVisualActivity.this, MyHydrationVisualActivity.this,
    ...
    private void reDrawGraph(String dateType) {
        ...
        if (dateType.equals("All")) {
            ...
            for (int jack = 0; jack < FireStoreDB.allGraphHydrationList.size(); jack++) {
                //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                barEntriesArrayList.add(new BarEntry(jack, (float) FireStoreDB.allGraphHydrationList.get(jack).getOunceValue()));
            }
            ...
            for (int jack = 0; jack < FireStoreDB.allGraphHydrationList.size(); jack++) {
                ...
                if (AppUtils.isDifference1Day(currentDate, AppUtils.parseFetchedDate(FireStoreDB.allGraphHydrationList.get(jack).getHydrationDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, (float)FireStoreDB.allGraphHydrationList.get(jack).getOunceValue()));
                }
            ...
            for (int jack = 0; jack < FireStoreDB.allGraphHydrationList.size(); jack++) {
                ...
                if (AppUtils.isDifference7Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.allGraphHydrationList.get(jack).getHydrationDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, (float)FireStoreDB.allGraphHydrationList.get(jack).getOunceValue()));
                }
            }
            ...
            for (int jack = 0; jack < FireStoreDB.allGraphHydrationList.size(); jack++) {
                ...
                if (AppUtils.isDifference14Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.allGraphHydrationList.get(jack).getHydrationDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, (float)FireStoreDB.allGraphHydrationList.get(jack).getOunceValue()));
                }
            }
            ...
            for (int jack = 0; jack < FireStoreDB.allGraphHydrationList.size(); jack++) {
                ...
                if (AppUtils.isDifference30Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.allGraphHydrationList.get(jack).getHydrationDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, (float)FireStoreDB.allGraphHydrationList.get(jack).getOunceValue()));
                }
            }
