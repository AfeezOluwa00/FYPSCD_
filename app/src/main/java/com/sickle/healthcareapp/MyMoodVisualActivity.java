...
public class MyMoodVisualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_visual_mood);
        ...
        fireStoreDB.getAllGraphMoodsData(MyMoodVisualActivity.this, MyMoodVisualActivity.this,
    ...
    private void reDrawGraph(String dateType) {
        ...
        if (dateType.equals("All")) {
            ...
            for (int jack = 0; jack < FireStoreDB.graphMoodsList.size(); jack++) {
                //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                barEntriesArrayList.add(new BarEntry(jack, FireStoreDB.graphMoodsList.get(jack).getSelectedMoodLevel()));
            }
            ...
            for (int jack = 0; jack < FireStoreDB.graphMoodsList.size(); jack++) {
                ...
                if (AppUtils.isDifference1Day(currentDate, AppUtils.parseFetchedDate(FireStoreDB.graphMoodsList.get(jack).getSelectedMoodNoteDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, FireStoreDB.graphMoodsList.get(jack).getSelectedMoodLevel()));
                }
            ...
            for (int jack = 0; jack < FireStoreDB.graphMoodsList.size(); jack++) {
                ...
                if (AppUtils.isDifference7Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.graphMoodsList.get(jack).getSelectedMoodNoteDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, FireStoreDB.graphMoodsList.get(jack).getSelectedMoodLevel()));
                }
            }
            ...
            for (int jack = 0; jack < FireStoreDB.graphMoodsList.size(); jack++) {
                ...
                if (AppUtils.isDifference14Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.graphMoodsList.get(jack).getSelectedMoodNoteDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, FireStoreDB.graphMoodsList.get(jack).getSelectedMoodLevel()));
                }
            }
            ...
            for (int jack = 0; jack < FireStoreDB.graphMoodsList.size(); jack++) {
                ...
                if (AppUtils.isDifference30Days(currentDate, AppUtils.parseFetchedDate(FireStoreDB.graphMoodsList.get(jack).getSelectedMoodNoteDate()))) {
                    //dateArray[jack] = FireStoreDB.graphMoodsList.get(jack).getPainNoteDate();
                    barEntriesArrayList.add(new BarEntry(jack, FireStoreDB.graphMoodsList.get(jack).getSelectedMoodLevel()));
                }
            }
    ...
    public void setGraphDataForVisualization() {
